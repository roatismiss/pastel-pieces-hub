  ...
  return (
    <div className="relative w-full h-64 overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <img 
          src="/lovable-uploads/b2a8efc7-04dd-4ec3-8f22-2114585f2fc4.png"
          alt="Community support - diverse group of people connecting and having meaningful conversations"
